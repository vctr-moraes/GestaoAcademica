...
namespace GestaoAcademica.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeMenorIgualMinimo(float valor, int minimo, string mensagem)
        {
            if (valor <= minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenorIgualMinimo(double valor, int minimo, string mensagem)
        {
            if (valor <= minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenorIgualMinimo(long valor, int minimo, string mensagem)
        {
            if (valor <= minimo)
            {
                throw new DomainException(mensagem);
